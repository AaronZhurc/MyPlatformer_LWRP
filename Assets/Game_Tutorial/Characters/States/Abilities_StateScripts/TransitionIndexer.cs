            ...
            foreach(TransitionConditionType c in transitionConditions){
                switch(c) {
                    ...
                    case TransitionConditionType.ATTACK: {
                            if(!control.ATTACK_DATA.AttackTriggered/*control.Attack*/) {
                                return false;
                            }
                            break;
                        }
                    ...
                    case TransitionConditionType.HOLDING_CROWBAR: {
                            if(control.animationProgress.HoldingWeapon == null) {
                                return false;
                            }
                            if(!control.animationProgress.HoldingWeapon.name.Contains("Crowbar")) {
                                return false;
                            }
                            break;
                        }
