    ...
    public class BoxColliderUpdater:SubComponent {
        ...
        public void UpdateBoxCollider_Size() {
            ...
            if(Vector3.SqrMagnitude(control.boxCollider.size - boxColliderData.TargetSize) > 0.00001f) {
                control.boxCollider.size = Vector3.Lerp(control.boxCollider.size, boxColliderData.TargetSize, Time.deltaTime * boxColliderData.Size_Update_Speed);
        ...
        public void UpdateBoxCollider_Center() {
            ...
            if(Vector3.SqrMagnitude(control.boxCollider.center - boxColliderData.TargetCenter) > 0.0001f) {
                control.boxCollider.center = Vector3.Lerp(control.boxCollider.center, boxColliderData.TargetCenter, Time.deltaTime * boxColliderData.Center_Update_Speed);
                boxColliderData.IsUpdatingSpheres = true;
            }
        }
